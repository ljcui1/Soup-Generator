...
public class Soup_Generator extends PApplet {
...
public void draw(){
  ...
  if(!restart){
    ...
    for (int i = 0; i < PApplet.parseInt(random(5, 12)); i++){
...
class Bowl {
  ...
  float w = 500;
  float h = 350;
  int r = PApplet.parseInt(random(0, 150));
  int g = PApplet.parseInt(random(0, 150));
  int b = PApplet.parseInt(random(0, 150));
  ...
  public void display(){
    r = PApplet.parseInt(random(0, 150));
    g = PApplet.parseInt(random(0, 150));
    b = PApplet.parseInt(random(0, 150));
...
class Soup {
  ...
  float w = 450;
  float h = 280;
  int r = PApplet.parseInt(random(50, 255));
  int g = PApplet.parseInt(random(10, 200));
  int b = PApplet.parseInt(random(0, 100));
  ...
  public void ingredients(boolean amt_rand, int amt){
    if(amt_rand == true){
      amt = PApplet.parseInt(random(5, 11));
    }
  ...
  public void ing_gen(boolean shape_rand, boolean rect_sel, boolean oval_sel, boolean tri_sel, boolean color_rand, float red, float green, float blue){
    println(color_rand);
    if(color_rand == true){
      red = random(50, 200);
      green = random(50, 200);
    ...
    while(test){
      ...
      if(insideSoup(baseX, baseY, x - 13, y - 90, w - 20, h - 20)){
        int sel = PApplet.parseInt(random(0, shapes.size()));
...
public boolean insideSoup(float x, float y, float centerX, float centerY, float w, float h){
  float dx = x - centerX;
  float dy = y - centerY;
...
class Slider{
  ...
  public void settings() { size(1500, 1080); }

  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Soup_Generator" };
    if (passedArgs != null) {
